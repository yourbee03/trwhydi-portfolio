...
function Contact(isDarkMode) {
    ...
    const onSubmit = async (event) => {
      ...
      formData.append("access_key", "b97e1ac3-16f7-4ac2-8b39-00b888007434");
  ...
  return (
    ...
    id="contact" className='w-full px-[12%] py-10 scroll-mt-20 bg-[url("/footer-bg-color.png")] bg-no-repeat bg-center bg-[lenght:90%_auto] dark:bg-none'>
      ...
      onSubmit={onSubmit} className='max-w-2xl mx-auto'>
        ...
        type='Submit'
        className='py-2 px-12 w-max flex items-center justify-between gap-2 bg-black/80 text-white rounded-full mx-auto hover:bg-black duration-500 dark:bg-transparent dark:border-[0.5px] dark:hover:bg-darkHover'
